...
// ---------------------------------------------------------------------------
server.registerTool("analyze_weld", {
    title: "Analyze Weld",
...
- process: Detected welding process (MIG, TIG, Stick, Flux-Core)`,
    ...
    const { imageUrl, process, material } = args;
    try {
...
// ---------------------------------------------------------------------------
server.registerTool("get_weld_defects", {
...
6. Inconsistent bead profile - uneven or irregular bead shape`,
    ...
    const defects = [
        {
            name: "Porosity",
            description: "Gas pockets or voids trapped in the weld metal during solidification. Looks like small holes or pits on the surface or internally.",
            causes: [
        ...
        {
            name: "Undercut",
            description: "A groove melted into the base metal along the edges of the weld, reducing the cross-sectional area of the base metal.",
            causes: [
            ...
            severity: "Moderate to severe - stress concentrations form at the undercut groove, leading to premature failure under load",
            awsStandard: "AWS D1.1 specifies maximum undercut depth limits",
        },
        {
            name: "Excessive Spatter",
            description: "Droplets of molten metal scattered around the weld, indicating inefficient transfer of filler metal.",
            causes: [
                "Arc length too long",
                "Excessive voltage",
        ...
        {
            name: "Cracks",
            description: "Fractures in the weld metal or heat-affected zone (HAZ). The most serious weld defect as they represent complete separation.",
            causes: [
            ...
            severity: "Critical - cracks are never acceptable in structural welds. They act as sharp notches and propagate under load.",
        ...
        },
        {
            ...
            description: "Lack of fusion where the weld bead rolls over the surface without properly bonding. Also called incomplete fusion.",
            causes: [
            ...
            severity: "Serious - creates a weak plane in the weld that can separate under stress. Often hidden from surface inspection.",
            awsStandard: "AWS D1.1 requires complete fusion at designated locations",
        },
        {
            name: "Inconsistent Bead Profile",
            description: "Uneven, wavy, or irregular weld bead shape. Includes undersized/oversized beads, excessive reinforcement, and irregular ripples.",
            causes: [
        ...
        content: [
            {
                type: "text",
                text: JSON.stringify({
                    summary: "DimeVision detects 6 categories of weld defects. Each defect has varying severity based on AWS/ASME standards.",
                    defects,
                }, null, 2),
            },
        ],
...
// ---------------------------------------------------------------------------
server.registerTool("get_bead_builder_tips", {
        ...
        content: [
            {
                type: "text",
                text: JSON.stringify({
                    summary: "Bead builder tips for MIG, TIG, and Stick welding. Focus on one process at a time for best results.",
                    tips,
                }, null, 2),
            },
        ],
...
// ---------------------------------------------------------------------------
server.registerTool("get_weld_quality_score", {
...
Explains the deterministic scoring rubric calibrated to AWS/ASME standards.`,
    ...
    const scoreGuide = {
        ...
        scoreRanges: {
            "90-100": {
                label: "Mastery",
                description: "Exceptional welds meeting or exceeding professional standards. Suitable for critical structural applications. Minimal to no visible defects.",
                requirements: [
            ...
            "75-89": {
                ...
                description: "Solid production welds suitable for most commercial and structural applications. Minor cosmetic defects may be present.",
                requirements: [
            ...
            "70-74": {
                ...
                description: "Passing score used by trade schools for certification readiness. Weld meets minimum requirements but has room for improvement.",
                requirements: [
            ...
            "50-69": {
                ...
                description: "Weld has defects that should be addressed. May fail AWS/ASME inspection. Grind out and re-weld recommended for production work.",
                defects: [
            ...
            "0-49": {
                ...
                description: "Weld has critical defects or widespread quality issues. Does not meet minimum AWS/ASME requirements. Should be ground out and re-welded.",
                defects: [
        ...
        content: [
            {
                type: "text",
                text: JSON.stringify({
                    summary: "DimeVision scores welds 0-100 using a deterministic rubric aligned with AWS/ASME standards. 75+ is professional quality; 90+ is mastery; 70 is the school pass threshold.",
                    scoreGuide,
                }, null, 2),
            },
        ],
